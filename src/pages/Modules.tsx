...
export default function Modules() {
  const cards = FEATURE_CARDS.slice(3);
        ...
        <div className="mx-auto max-w-7xl">
          <BlurFade delay={0.1} inView>
            <div className="mb-16 text-center">
              <p className="mb-3 text-sm font-medium text-primary">MODULES</p>
              <h1 className="text-4xl font-bold md:text-5xl">Monitoring Capabilities</h1>
              <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                Deep capabilities across analytics, alerting, and sustainability reporting.
              </p>
            </div>
          </BlurFade>
