...
import { IntroVideoOverlay } from "@/components/marketing/IntroVideoOverlay";
          ...
          <div className="relative z-10 mx-auto max-w-7xl text-center">
            ...
            <BlurFade delay={0.3} inView>
              <p className="mx-auto mt-8 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg">
                EcoGrid delivers real-time IoT monitoring and alerts for
                campuses and institutions. Sensors, cloud, and role-based
          ...
          <div className="mx-auto max-w-3xl text-center">
            <BlurFade delay={0.1} inView>
              ...
              <p className="mb-8 text-lg text-muted-foreground">
                Connect your IoT sensors and start monitoring electricity,
                water, and waste in real-time.
              </p>
              <Link to="/login">
                <ShimmerButton
                  shimmerColor="#22c55e"
